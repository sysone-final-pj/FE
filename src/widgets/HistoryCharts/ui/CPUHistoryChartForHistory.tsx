 ...
 */
/********************************************************************************************
 * 📈 CPUHistoryChartForHistory.tsx
 * HistoryPage용 CPU 사용률 추이 차트 (Time Range)
 ********************************************************************************************/
import {
  useState,
  useEffect,
...
export const CPUHistoryChartForHistory = ({ containerId, containerName }: Props) => {
        ...
        {!containerId ? (
          <div className="h-full flex items-center justify-center">
            <p className="text-gray-400 text-sm">
              Select a container to view CPU metrics
            </p>
          </div>
        ) : !timeFilter ? (
          <div className="h-full flex items-center justify-center">
