  ...
  return (
    <div className="bg-white py-[5px] px-4 flex items-center border-b border-[#EBEBF1]">
      ...
      <div className="p-2.5 flex items-center w-[400px]">
        <span className="text-[#555555] font-medium text-base">{agent.hashcode}</span>
      </div>
      ...
      <div className="p-2.5 flex items-center justify-center w-[150px]">
        <span className="text-tertiary font-medium text-base">{agent.created}</span>
      </div>

      {/* Operation */}
      <div className="px-2.5 flex items-center justify-center gap-1.5 w-[307px]">
        <button
        ...
        >
          <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none">
            <circle cx="12" cy="12" r="9" stroke="#14ba6d" strokeWidth="1.5" />
            <path d="M12 16V12M12 8H12.01" stroke="#14ba6d" strokeWidth="1.5" strokeLinecap="round" />
          </svg>
